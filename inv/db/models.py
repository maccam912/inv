...
class Site(Base):
    ...
    shipments: Mapped[list["Shipment"]] = relationship(
        "Shipment", back_populates="site"
    )
    inventory: Mapped[list["Inventory"]] = relationship(
        "Inventory", back_populates="site"
    )
...
class Shipment(Base):
    ...
    anticipated_arrival_date: Mapped[date | None] = mapped_column(Date, nullable=True)
